            ...
            <div class="border border-neutral-900 p-1 mr-10 ml-10 mx-auto mt-5">
                <div class="border border-neutral-900 p-1">
                    <div class="grid grid-cols-3">
                        ...
                        <div></div>
                        <div class="text-xs">
                            <img class="w-24 h-auto overflow-hidden sm:w-64 self-center justify-self-end" src="{{ URL::to('/') }}/storage/evaluation/BPA-Evaluation.jpg" alt="" >
                        </div>
                    </div>
                </div>
                <div class="border border-neutral-900 p-2 mt-2">
                    <div class="grid grid-cols-12 items-center gap-x-2 text-xs">
                        <!-- Site/Branch Location -->
                        {{-- <div class="col-span-1"></div> --}}
                        <div class="col-span-3 text-right">Site/Branch Location:</div>
                        <div class="col-span-3 border-b border-neutral-900 h-5"></div>

                        <!-- Spacer -->
                        {{-- <div class="col-span-1"></div> --}}

                        <!-- Audit Date -->
                        <div class="col-span-2 text-right">Audit Date:</div>
                        <div class="col-span-3 border-b border-neutral-900 h-5 text-center">05/15/1996 - 05/20/1996</div>
                        <div class="col-span-1"></div>
                    </div>
                    <div class="grid grid-cols-12 items-center gap-x-2 text-xs">
                        <!-- Site/Branch Location -->
                        {{-- <div class="col-span-1"></div> --}}
                        <div class="col-span-3 text-right">Site/Branch Supervisor/TL:</div>
                        <div class="col-span-3 border-b border-neutral-900 h-5"></div>
                        ...
                        <!-- Audit Date -->
                        <div class="col-span-2 text-right">Audit Days:</div>
                        <div class="col-span-3 border-b border-neutral-900 h-5 text-center">5</div>
                        <div class="col-span-1"></div>
                    </div>
                </div>
                ...
                <!-- Descriptor Row -->
                    {{-- Header --}}
                        <div class="flex mt-2 w-full">
                            <div class="border-t border-b border-l border-neutral-900 flex items-center justify-center p-0.5 basis-1/6"><span class="font-semibold">Rating</span></div>
                            <div class="border-t border-b border-l border-neutral-900 flex items-center justify-center p-0.5 basis-3/6 text-[11px]"><span class="font-semibold">Description</span></div>
                            <div class="border-t border-b border-l border-neutral-900 flex items-center justify-center p-0.5 basis-1/6"><span class="font-semibold">Grading Scale</span></div>
                            <div class="border border-neutral-900 flex items-center justify-center p-0.5 basis-1/6"><span class="font-semibold">Remarks</span></div>
                        </div>
                    {{-- Body --}}
