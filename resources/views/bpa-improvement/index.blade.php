                            ...
                            <form class="mb-6">
                                <div class="w-full text-gray-900 bg-white border border-gray-200 rounded-lg">
                                    <div class="relative inline-flex items-center w-full px-4 py-2 text-sm font-medium border-b border-gray-200">
                                        ...
                                        <input type="text" id="SUMGenOp" class="bg-gray-50 text-center font-medium border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block py-1 w-24 disabled:pointer-events-none" placeholder="0"  value="{{ $surveyScores[1] ?? 0 }}" readonly />
                                    ...
                                    <div class="relative inline-flex items-center w-full px-4 py-2 text-sm font-medium border-b border-gray-200">
                                        ...
                                        <input type="text" id="SUMDoc" class="bg-gray-50 text-center font-medium border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block py-1 w-24 disabled:pointer-events-none" placeholder="0"  value="{{ $surveyScores[2] ?? 0 }}" readonly />
                                    ...
                                    <div class="relative inline-flex items-center w-full px-4 py-2 text-sm font-medium border-b border-gray-200">
                                        ...
                                        <input type="text" id="SUMPartM" class="bg-gray-50 text-center font-medium border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block py-1 w-24 disabled:pointer-events-none" placeholder="0"  value="{{ $surveyScores[3] ?? 0 }}" readonly />
                                    ...
                                    <div class="relative inline-flex items-center w-full px-4 py-2 text-sm font-medium border-b border-gray-200 rounded-t-lg">
                                        ...
                                        <input type="text" id="SUMPer" class="bg-gray-50 text-center font-medium border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block py-1 w-24 disabled:pointer-events-none" placeholder="0"  value="{{ $surveyScores[4] ?? 0 }}" readonly />
                                    ...
                                    <div class="relative inline-flex items-center w-full px-4 py-2 text-sm font-medium border-b border-gray-200 rounded-t-lg">
                                        ...
                                        <input type="text" id="SUM5S" class="bg-gray-50 text-center font-medium border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block py-1 w-24 disabled:pointer-events-none" placeholder="0" value="{{ $surveyScores[5] ?? 0 }}" readonly />
                                    ...
                                    <div class="relative inline-flex flex-col items-center w-full px-4 py-2 text-sm font-medium rounded-b-lg">
                                        <div class="flex gap-4">
                                            ...
                                            <div class="flex flex-col items-center">
                                                <input type="text" id="PTotal" class="bg-gray-50 text-center font-semibold border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block py-1 w-24 mb-2 readonly:pointer-events-none" placeholder="0" value="{{ $surveyScoreSum ?? 0 }}" readonly />
        ...
        $(document).ready(function () {
            ...
            // GET VALUE OF RANGE AND REMARKS
                ...
                function updateSums() {
                    ...
                    // Update category-specific SUM fields
                    ...
                    // Update category-specific Percentage fields
