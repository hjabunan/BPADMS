                    ...
                    <div class="px-4 grid grid-cols-[1fr_auto] gap-x-3 border-b h-[59px] mb-2">
                        ...
                        <div class="justify-self-end">
                            <div class="border-b border-gray-200">
                                ...
                                <div class="md:hidden p-2" x-data="{ openTab: '' }">
                                    <select class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block h-10 w-full p-2.5" 
                                            @change="document.getElementById($event.target.value).click()">/;''\0.0...0........
                                        <option value="formprocess-tab">Process</option>
                                        <option value="cpoint-tab">Checkpoint</option>
                                        <option value="question-tab">Question</option>
                                        <option value="questionnaire-tab">Questionnaire</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="flex flex-col md:flex-row gap-2 justify-center sm:flex-nowrap h-[calc(100vh-210px)]">
                                            ...
                                            <table id="formTable" class="hidden md:block w-full text-sm text-left text-gray-500">
                                                <thead class="text-xs text-gray-700 uppercase bg-white sticky top-[50px] shadow-md">
                                                    <tr>
                                                        ...
                                                        <th class="px-6 py-2 text-center w-[80%]">Form Name</th>
                                    ...
                                    {{-- PROCESS Section --}}
                                        <div class="flex-1 overflow-x-auto shadow-md sm:rounded-lg h-1/2 md:h-auto">
                                            ...
                                            <!-- Desktop Table -->
                                            <table id="processTable" class="hidden md:block w-full text-sm text-left text-gray-500">
                                                <thead class="text-xs text-gray-700 uppercase bg-white sticky top-[50px] shadow-md">
                                                    <tr>
                                                        <th class="px-6 py-2 text-center w-[10%]">Action</th>
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50" id="cpoint" role="tabpanel" aria-labelledby="cpoint-tab">
                                ...
                                <div class="relative overflow-x-auto shadow-md sm:rounded-lg" style="flex: 1; height: calc(100vh - 210px);">
                                    ...
                                    <!-- <div class="w-full overflow-x-auto"> -->
                                        <table id="cpointTable" class="md:block w-full text-sm text-left text-gray-500" style="max-height: calc(100% - 49px);">
                                            <thead class="text-xs text-gray-700 uppercase bg-white sticky top-[50px] shadow-md">
                                                <tr>
