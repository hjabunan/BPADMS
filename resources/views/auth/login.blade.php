<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label for="idnum" :value="__('Username')" />
            <x-text-input id="idnum" class="block mt-1 w-full" type="text" name="idnum" :value="old('idnum')" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <div class="relative">
                ...
                <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                    <button type="button" id="togglePassword" class="text-gray-400 hover:text-gray-700 focus:outline-none" tabindex="-1">
